    ...
    <>
      ...
      <section className="relative overflow-hidden bg-[#D8CCBA] text-black">
        ...
        <div className="relative z-1 max-w-[1200px] mx-auto px-6 py-10 lg:py-10 text-center">
          ...
          {/* Second heading */}
          <h3 className="mt-[14px] font-bold text-[36px] md:text-[54px] lg:text-[72px] font-goudy-old lg:font-goudy-agency leading-[1.15] text-black"> Ideas distilled to brilliance </h3>
          {/* Icon row */}
          <div className=" grid grid-cols-1 md:grid-cols-3 gap-14 md:gap-8 mt-6  mx-auto">
            ...
            <div className="flex flex-col items-center text-center  w-full ml-auto">
              ...
              <h4 className="font-bold text-[24px] md:text-[30px] lg:text-[36px] md:mt-5 font-goudy lg:font-goudy-old max-w-[270px] md:max-w-[250px] text-black leading-9.5">The Sculptor's Gaze</h4>
      ...
      <section className="relative flex flex-col justify-center items-center overflow-hidden bg-[#D8CCBA] text-black min-h-[435px] text-center px-6">
        ...
        {/* Content */}
        <div className="relative z-1 max-w-[1200px] mx-auto flex flex-col items-center gap-8 pb-10">
          {/* Main heading */}
          <h1 className="text-[36px] md:text-[54px] lg:text-[72px] max-w-[667px] mt-7 font-bold font-goudy-old lg:font-goudy-agency">
            The Residency
          </h1>

          {/* Quote */}
          <div className="max-w-[900px] mx-auto">
            <h2 className="text-[24px] md:text-[30px] lg:text-[36px] font-goudy leading-snug">
              Everything should be made as simple as possible, but no simpler
            </h2>
            <p className="text-right text-[20px] md:text-[22px] lg:text-[24px] mt-2 font-goudy">
              ~ Albert Einstein
            </p>
          </div>
          ...
          {/* Tagline */}
          <p className="text-[20px] md:text-[26px] lg:text-[32px] font-goudy text-center text-shadow-[0px_4px_20px_rgba(0,0,0,0.5)]">
      ...
      <section className="relative overflow-hidden bg-[#D8CCBA] text-black px-6 py-[51px]">
        ...
        <div className="relative z-1 max-w-[1400px] mx-auto text-center">
          ...
          {/* paragraph */}
          <p className="mt-6 text-[20px] md:text-[22px] lg:text-[24px] text-black text-center text-justify sm:text-center max-w-[1245px] font-goudy mx-auto leading-tight text-shadow-[0px_4px_20px_rgba(0,0,0,0.5)]">
        ...
        <div className="relative z-1 max-w-[1400px] mx-auto flex flex-col gap-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mx-4 lg:mx-20">
            ...
            <div className="flex flex-col text-center lg:text-left max-w-[700px] order-2 lg:order-1">
              <h2 className="font-bold text-[36px] md:text-[54px] lg:text-[72px] font-goudy lg:font-goudy-old lg:text-nowrap leading-18 text-black">
                Resident Expertise
                <br />
                Derived Naturally
              </h2>

              <p className="mt-6 text-[24px] md:text-[30px] lg:text-[36px] font-goudy text-black max-w-[680px] leading-tight">
