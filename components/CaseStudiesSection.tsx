  ...
  return (
    <section className="relative overflow-hidden bg-[#D8CCBA] text-black flex flex-col items-center py-6 px-8">
      ...
      <div className="relative z-10 text-center ">
        <h1 className="text-4xl md:text-5xl lg:text-7xl font-goudy-agency font-bold mb-4 leading-[1.1] ">
          Case Studies
        </h1>

        <p className="text-2xl md:text-3xl lg:text-4xl font-extrabold md:max-w-[950px] font-goudy-old">
