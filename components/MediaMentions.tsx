  ...
  return (
    <section className="relative bg-[#D5C7B3] py-4 sm:py-6 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto text-center mb-6 sm:mb-8 px-4">
        <h2 className="font-goudy-agency text-4xl md:text-5xl lg:text-7xl  leading-tight font-bold text-black ">
          {title}
        </h2>
      </div>
      ...
      <div className="relative z-10 h-full px-3 sm:px-4 md:px-5 pt-4 sm:pt-6 pb-10 sm:pb-12 flex flex-col text-white">
        ...
        <div className="flex items-center justify-center mb-1">
          {mention.logo ? (
            ...
            <p className="font-goudy-agency text-2xl sm:text-3xl md:text-4xl font-semibold">{mention.outlet}</p>
          )}
        </div>
        <div className="border border-b-2 border-black"></div>
        <div className="border border-b-1 mt-1 mb-1 border-black"></div>
        ...
        <div className={`text-center font-goudy-agency tracking-wide mb-1 font-bold text-black ${emphasized ? 'text-xl sm:text-2xl md:text-3xl' : 'text-base sm:text-lg md:text-xl'}`}>
          {mention.headline}
        </div>
        ...
        <div className="flex gap-3 mt-2 mb-4 flex-1 items-start">
          <div className="flex-1">
            <blockquote className={`italic text-sm sm:text-base md:text-lg leading-snug text-black font-goudy  font-bold  ${emphasized ? 'text-lg sm:text-xl' : ''}`}>
        ...
        {/* Footer Intro */}
        <p className="text-[11px] sm:text-[12px] md:text-[13px] leading-snug font-semibold text-black font-goudy mt-auto">
          {mention.intro || ''}
        </p>
