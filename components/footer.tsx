    ...
    <footer className="bg-[#24211F] text-gray-300">
      ...
      <div className="mx-auto max-w-[850px] px-6 sm:px-8 lg:px-12 py-4 sm:py-6 items-center">
        ...
        <div className="md:hidden block flex flex-row items-center justify-center w-full gap-6 px-6 mx-auto">
          <div className="flex flex-col space-y-2 font-['Goudy Bookletter 1911'] text-center text-nowrap">
        ...
        >
          ...
          {/* Column 1 */}
          <div className="space-y-2 font-['Goudy Bookletter 1911']">
            <Link href="/" className="block text-xl md:text-2xl text-white">
              Home
            </Link>
        ...
        <div className="flex flex-col justify-center items-center gap-2 my-2 sm:gap-3 sm:my-3 font-['Goudy Bookletter 1911']">
          <h1 className="text-xl text-2xl font-['Goudy Bookletter 1911'] md:hidden ">Our Socials:</h1>
        ...
        <div className="flex flex-col items-center text-center space-y-0.5 sm:space-y-1">
          ...
          <p className="mt-0.5 sm:mt-1 text-[#BFBFBF] text-sm md:text-2xl font-['Goudy Bookletter 1911']">
          ...
          <p className="text-[#BFBFBF] text-sm md:text-2xl mt-0.5 sm:mt-1 font-['Goudy Bookletter 1911']">Made with intention and purpose</p>

          {/* Policies */}
          <div className="flex flex-wrap justify-center text-[#BFBFBF] gap-x-1.5 sm:gap-x-2 gap-y-0.5 text-sm md:text-2xl mt-0.5 font-['Goudy Bookletter 1911']">
          ...
          <p className="text-[#BFBFBF] text-sm md:text-2xl mt-0.5 sm:mt-1 font-['Goudy Bookletter 1911']">
