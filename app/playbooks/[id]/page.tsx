    ...
    <div className="pt-20">
      <div className="flex flex-col md:flex-row justify-between bg-[#0E4943] w-full items-center px-4 py-6 md:py-6 gap-3 md:gap-4 relative z-10">
        ...
        <div className="flex-1 flex items-center justify-center text-center px-2 min-w-0">
          <h1 className="text-white text-2xl max-w-[630px] mx-auto text-center md:text-4xl font-['Goudy Old Style'] font-bold line-clamp-2">{playbook?.title}</h1>
        </div>
        ...
        <main className="max-w-7xl mx-auto px-8 py-12 text-lg md:text-xl">
          ...
          <article className="bg-[#D5C7B3]   border-gray-800 overflow-hidden ">
            ...
            <div className="p-2 text-justify md:text-left">
              {/* Title & Introduction */}
              <h1 className="text-3xl md:text-6xl lg:text-7xl font-['OPTIGoudy Agency'] font-bold text-center md:text-left leading-tight tracking-tight mb-6 w-full">{playbook.title}</h1>
            <div className="mb-8">
              <p className="text-[20px] md:text-2xl font-['Goudy Bookletter 1911'] leading-relaxed">{playbook.introduction}</p>
            </div>
