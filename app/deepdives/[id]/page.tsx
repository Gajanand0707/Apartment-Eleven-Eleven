        ...
        <main className="max-w-7xl mx-auto px-8 py-12 text-lg md:text-xl">
          ...
          <article className="bg-[#D5C7B3]   border-gray-800 overflow-hidden ">
            ...
            <div className="p-2 text-justify md:text-left">
              {/* Article Title */}
              <h1 className="text-3xl md:text-6xl lg:text-7xl font-goudy-old font-bold text-center md:text-left leading-tight tracking-tight mb-6 w-full">
                {article.title ?? article.article_name}
              </h1>
                ...
                <div className="mt-12 pt-8  space-y-8">
                  ...
                  {article.conclusion.map((c) => (
                    <div key={c.id}>
                      ...
                      {c.slogan && (
                        <p className="text-2xl md:text-4xl text-center font-semibold font-goudy-old max-w-[670px] justify-center mx-auto mb-4">{c.slogan}</p>
                      )}
                    </div>
                  ))}
                </div>
              ...
              {article.reference && article.reference.length > 0 && (
                <div className="mt-12 pt-8">
                  <h1 className="text-2xl md:text-4xl text-center font-goudy-old font-bold">References</h1>
