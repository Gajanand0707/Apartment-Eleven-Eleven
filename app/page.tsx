...
export default function Home() {
  return (
    ...
    <div className={ebg.className}>
      ...
      <section className="relative overflow-hidden bg-[#D8CCBA] text-black"> {/* Background texture */} <Image src={midsec} alt="Section background texture" fill priority style={{ objectFit: "cover", objectPosition: "center" }} className="opacity-80" /> {/* Content */} <div className="relative z-[1] max-w-[1400px] mx-auto px-6 py-16 lg:py-20 text-center"> {/* Top heading */} <h2 className="font-bold text-4xl sm:text-5xl lg:text-[56px] leading-[1.15] text-[#0E4943]"> Praxis For The New Renaissance </h2> {/* Divider line */} <div className="mt-8 w-full flex justify-center"> <div className="h-[2px] w-full max-w-[900px] bg-black" /> </div> {/* Second heading */} <h3 className="mt-10 font-bold text-4xl sm:text-5xl lg:text-[56px] leading-[1.15] text-black"> Ideas distilled to brilliance </h3> {/* Icon row */} <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8"> {/* Card 1 */} <div className="flex flex-col items-center text-center max-w-[380px] mx-auto"> <div className="w-[140px] h-[140px] relative"> <Image src={ideas1} alt="The Patrons of Progress" fill style={{ objectFit: "contain" }} /> </div> <h4 className="font-semibold text-2xl mt-6 text-black"> The Patrons of Progress </h4> <p className="mt-4 text-base leading-relaxed text-black max-w-[320px]"> More than backers, we are enablers of the ‘new India,’ providing the strategic architecture for its creation. </p> </div> {/* Card 2 */} <div className="flex flex-col items-center text-center max-w-[380px] mx-auto"> <div className="w-[140px] h-[140px] relative"> <Image src={ideas2} alt="Where Foresight Meets Fortitude" fill style={{ objectFit: "contain" }} /> </div> <h4 className="font-semibold text-2xl mt-6 text-black"> Where Foresight Meets Fortitude </h4> <p className="mt-4 text-base leading-relaxed text-black max-w-[340px]"> With foresight, we identify defining opportunities early; with fortitude and conviction, we build them alongside you. </p> </div> {/* Card 3 */} <div className="flex flex-col items-center text-center max-w-[380px] mx-auto"> <div className="w-[140px] h-[140px] relative"> <Image src={ideas3} alt="The Sculptor’s Gaze" fill style={{ objectFit: "contain" }} /> </div> <h4 className="font-semibold text-2xl mt-6 text-black"> The Sculptor’s Gaze </h4> <p className="mt-4 text-base leading-relaxed text-black max-w-[340px]"> We see the potential others miss, guiding you to remove noise and reveal your lasting value. </p> </div> </div> </div> </section>
      <ScienceSection />
