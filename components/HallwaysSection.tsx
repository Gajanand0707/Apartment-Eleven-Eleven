  ...
  <div className="absolute inset-0 z-0">
    ...
    <div className="absolute inset-0 bg-white/20 pointer-events-none" />
        ...
        <div className="relative z-10 text-center  mb-16">
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-['OPTIGoudy Agency'] font-bold md:mt-16 text-black">
            Conversations in the Hallways
          </h1>
          <p className="mt-4 text-2xl md:text-3xl lg:text-4xl md:px-20 font-['Goudy Old Style'] font-semibold  text-black  mx-auto">
...
>
  <p className={`font-['Goudy Bookletter 1911'] text-[20px] md:text-2xl italic leading-snug max-w-[85%] mx-auto text-black ${size === 'small' ? 'max-h-20 overflow-auto md:max-h-none' : ''}`}>
    "{item.quote}"
  </p>
  <h3 className="mt-8 text-2xl md:text-3xl lg:text-4xl font-semibold font-['OPTIGoudy Agency'] text-black">
    {item.name}
  </h3>
  <p className="text-2xl md:text-3xl lg:text-4xl font-['Goudy Old Style'] mt-2 text-gray-900">
