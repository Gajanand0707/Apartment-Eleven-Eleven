    ...
    <Link href={blog.readMoreUrl || "#"}>
      <div className="rounded-[56px] border-2 border-gray-800 overflow-hidden gap-x-8 bg-white hover:shadow-lg transition-shadow flex flex-col cursor-pointer">
        ...
        <div className="p-6 md:p-10 flex flex-col justify-between grow">
          <div>
            <h3 className="text-xl md:text-2xl font-['OPTIGoudy Agency'] font-bold text-gray-900 text-center mb-2">{blog.title}</h3>
            {/* <p className=" text-[20px] md:text-2xl font-['Goudy Bookletter 1911'] leading-relaxed line-clamp-2 mb-3">{blog.description}</p> */}
          </div>
          <span className="text-blue-500 font-['Goudy Bookletter 1911'] text-xl md:text-2xl  text-center hover:underline pointer-events-none">
            Read more...
          </span>
        </div>
      </div>
