      ...
      {hasMore && (
        <div className="mt-16 flex justify-center">
          <button
            ...
            className="px-8 py-3 border-2 w-44 bg-white border-gray-900 text-gray-900 text-xl md:text-2xl font-['Goudy Bookletter 1911'] rounded-lg hover:bg-gray-900 hover:text-white transition-colors"
          >
            Load More
          </button>
        </div>
