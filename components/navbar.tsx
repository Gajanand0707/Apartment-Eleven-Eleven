            ...
            <ul className="flex items-center gap-6">
              {navItems.map((item) => (
                <li key={item.href}>
                  <a
                    href={item.href}
                    className="text-black hover:text-gray-700 text-xl md:text-2xl font-goudy transition-colors"
                  >
                    {item.label}
                  </a>
                </li>
              ...
              {navItems.map((item) => (
                <li key={item.href} className="w-full text-center bg-[#D6CBBB]">
                  <a
                    href={item.href}
                    onClick={() => setOpen(false)}
                    className="block text-2xl md:text-4xl bg-[#D6CBBB] font-goudy text-black hover:text-gray-600 py-2 font-goudy"
                  >
                    {item.label}
                  </a>
                </li>
