  ...
  <div className="space-y-0.5 sm:space-y-1 md:space-y-2 font-['Goudy_Bookletter_1911']">
    ...
    <Link href="/inside" className="block text-xl md:text-2xl hover:text-white">
      Inside Our Doors
        ...
        {/* Social Icons */}
        <div className="flex justify-center items-center gap-2 my-2 sm:gap-3 sm:my-3 font-['Goudy_Bookletter_1911']">
  ...
  <div className="flex flex-col leading-tight">
    ...
    <h2 className="text-gray-300 text-sm font-semibold tracking-[0.3em]">
      ELEVEN ELEVEN
          ...
          <p className="mt-0.5 sm:mt-1 text-gray-300 text-sm font-['Goudy_Bookletter_1911']">
          ...
          <p className="text-gray-500 text-xs mt-0.5 sm:mt-1 font-['Goudy_Bookletter_1911']">Made with intention and purpose</p>
          {/* Policies */}
          <div className="flex flex-wrap justify-center gap-x-1.5 sm:gap-x-2 gap-y-0.5 text-sm mt-0.5 font-['Goudy_Bookletter_1911']">
          ...
          <p className="text-gray-500 text-xs mt-0.5 sm:mt-1 font-['Goudy_Bookletter_1911']">
