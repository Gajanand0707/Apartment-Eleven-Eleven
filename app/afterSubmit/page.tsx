    ...
    return (
        <div className="relative w-full min-h-screen">
            ...
            <div className="relative z-20 flex items-center justify-center min-h-screen px-6">
                <p className="text-center text-4xl md:text-7xl font-['Goudy Old Style'] backdrop-blur-sm text-white ">
            ...
            <div className="fixed bottom-6 left-0 right-0 flex justify-center z-30">
                <div className="bg-black/60 text-white text-xl md:text-2xl py-2 px-4 rounded-lg font-['Goudy Bookletter 1911'] backdrop-blur-sm">
