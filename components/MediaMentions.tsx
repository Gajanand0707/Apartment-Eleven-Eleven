  ...
  return (
    <section className="relative bg-[#D5C7B3] py-4 sm:py-6 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto text-center mb-6 sm:mb-8 px-4">
        <h2 className="font-['Playfair_Display'] text-3xl sm:text-4xl md:text-5xl lg:text-[56px] leading-tight font-bold text-black drop-shadow-[0_2px_0_rgba(0,0,0,0.2)] sm:drop-shadow-[0_3px_0_rgba(0,0,0,0.25)]">
          {title}
        </h2>
      </div>
...
function NewspaperCard({
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-2.5 right-2.5 top-[58px] h-0.5 bg-[#4a331d]/80" />
