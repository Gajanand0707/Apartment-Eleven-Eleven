...
export default function Home() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      setShowNavbar(window.scrollY > (heroHeight * 7 + 100));
    };
    ...
    <>
      ...
      <section className="relative overflow-hidden bg-[#D8CCBA] text-black">
        ...
        <div className="relative z-1 max-w-[1200px] mx-auto px-6 py-10 lg:py-10 text-center">
          ...
          {/* Top heading */}
          <h2 className="font-bold text-4xl text-center md:text-5xl lg:text-7xl leading-[1.15] max-w-[327px] md:max-w-[900px] lg:max-w-[1200px] mx-auto font-['OPTIGoudy Agency'] md:whitespace-normal"> Praxis For The New Renaissance </h2>

          <p className="text-2xl md:text-3xl lg:text-4xl leading-[1.15] text-center max-w-[1095px] font-['Goudy Bookletter 1911'] my-4  md:my-4"> Sometimes it's founders that can bring everything together, other times you need experts at resource building to help.
          ...
          {/* Second heading */}
          <h3 className="mt-[14px] font-bold text-4xl sm:text-5xl lg:text-7xl  font-['OPTIGoudy Agency'] leading-[1.15] text-black"> Ideas distilled to brilliance </h3>
          {/* Icon row */}
          <div className=" grid grid-cols-1 md:grid-cols-3 gap-14 md:gap-8 mt-6  mx-auto">
            ...
            <div className="flex flex-col items-center text-center  w-full mx-auto">
              ...
              <h4 className="font-bold text-[28px] lg:text-4xl md:mt-5 font-['OPTIGoudy Agency'] max-w-[250px] md:max-w-[285px] text-black">Where Foresight Meets Fortitude</h4>
              <p className="mt-2.5 text-xl lg:text-2xl leading-tight font-['Goudy Bookletter 1911'] text-black max-w-[299px]">With foresight, we identify defining opportunities early; with fortitude and conviction, we build them alongside you.</p>
            </div>
            {/* Card 2 */}
            <div className="flex flex-col  items-center text-center w-full mx-auto">
              <div className="w-[255px] h-[255px] relative overflow-hidden">
              ...
              <h4 className="font-bold text-[28px] lg:text-4xl md:mt-5 justify-center  md:max-w-[250px] font-['OPTIGoudy Agency'] text-black">The Patrons of Progress</h4>
              <p className="mt-2.5 text-xl lg:text-2xl leading-tight font-['Goudy Bookletter 1911'] text-black max-w-[299px]">More than backers, we are enablers of the ‘new India,’ providing the strategic architecture for its creation.</p>
            </div>
            {/* Card 3 */}
            <div className="flex flex-col items-center text-center  w-full ml-auto">
              ...
              <h4 className="font-bold text-[28px] lg:text-4xl md:mt-5 font-['OPTIGoudy Agency'] max-w-[270px] md:max-w-[250px] text-black">The Sculptor’s Gaze</h4>
              <p className="mt-2.5 text-xl lg:text-2xl leading-tight text-black max-w-[299px] font-['Goudy Bookletter 1911']">We see the potential others miss, guiding you to remove noise and reveal your lasting value.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="relative flex flex-col justify-center items-center overflow-hidden bg-[#D8CCBA] text-black min-h-[435px] text-center px-6">
        ...
        <div className="relative z-1 max-w-[1200px] mx-auto flex flex-col items-center gap-8">
          {/* Main heading */}
          <h1 className="text-4xl md:text-5xl lgd:text-7xl max-w-[667px] mt-7 font-bold font-['OPTIGoudy Agency']">
            The Residency
          </h1>

          {/* Quote */}
          <div className="max-w-[900px] mx-auto">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-['Goudy Bookletter 1911'] leading-snug">
              Everything should be made as simple as possible, but no simpler
            </h2>
            <p className="text-right text-xl mt-2 font-['Goudy Bookletter 1911']">
              ~ Albert Einstein
            </p>
          </div>
          ...
          {/* Button */}
          <a href="/elevators">
          <TextureButton className="text-2xl md:text-3xl lg:text-4xl px-8 py-3  font-['Goudy Bookletter 1911']">
            Elevator’s Waiting
          </TextureButton>
          </a>

          {/* Tagline */}
          <p className=" text-xl md:text-2xl  font-['Goudy Bookletter 1911'] text-center">
      ...
      <section className="relative overflow-hidden bg-[#D8CCBA] text-black px-6 py-[51px]">
        ...
        <div className="relative z-1 max-w-[1400px] mx-auto text-center">
          {/* heading */}
          <h1 className="text-4xl md:text-4xl font-bold font-['OPTIGoudy Agency'] text-black">
            Meet our Residency Panel
          </h1>

          {/* paragraph */}
          <p className="mt-8 text-xl md:text-2xl text-shadow-2xs text-black text-center text-justify sm:text-center max-w-[1245px] font-['Goudy Bookletter 1911'] mx-auto">
      ...
      <section className="relative overflow-hidden bg-[#D8CCBA] text-black px-6 py-4">
        ...
        <div className="relative z-1 max-w-[1400px] mx-auto flex flex-col gap-12">
          <h1 className="text-center font-bold text-4xl  md:text-7xl font-['OPTIGoudy Agency']">
            Our Residents
          </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mx-4 lg:mx-20">
            ...
            <div className="flex flex-col text-center lg:text-left max-w-[700px] order-2 lg:order-1">
              <h2 className="font-bold text-4xl  lg:text-7xl  font-['OPTIGoudy Agency']  lg:text-nowrap text-black">
                Resident Expertise
                <br />
                Derived Naturally
              </h2>

              <p className="mt-6 text-2xl lg:text-4xl font-['Goudy Bookletter 1911'] text-black max-w-[680px]">
              ...
              <div className="mt-10">
                <a href="/inside">
                <TextureButton className="text-2xl lg:text-4xl px-8 py-3 font-['Goudy Old Style']">
                  View all Residents
                </TextureButton>
                </a>
              </div>
