  ...
  <div className="absolute inset-0 z-0">
    ...
    <div className="absolute inset-0 bg-white/20 pointer-events-none" />
        ...
        <div className="relative z-10 text-center  mb-16">
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-goudy-agency font-bold md:mt-16 text-black">
            Conversations in the Hallways
          </h1>
          <p className="mt-4 text-2xl md:text-3xl lg:text-4xl md:px-20 font-goudy-old font-semibold  text-black  mx-auto">
