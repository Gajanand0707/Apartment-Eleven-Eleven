  ...
  return (
    <section className="relative overflow-hidden bg-[#D8CCBA] text-black flex flex-col items-center py-6 px-8">
      ...
      <div className="relative z-10 text-center ">
        <h1 className="text-4xl md:text-5xl lg:text-7xl font-['OPTIGoudy Agency'] font-bold mb-4 leading-[1.1] ">
          Case Studies
        </h1>

        <p className="text-2xl md:text-3xl lg:text-4xl font-extrabold md:max-w-[950px] font-['Goudy Old Style']">
      ...
      {typeof limit === "number" && (
        <Link href="/caseStudy" className="relative z-10 mt-16 mb-8 inline-block">
          <span className="bg-[#014A43] text-white text-2xl md:text-3xl lg:text-4xl font-['Goudy Old Style'] font-semibold px-8 py-4 rounded-[28px] hover:bg-[#016A60] transition-colors pointer-events-none">
