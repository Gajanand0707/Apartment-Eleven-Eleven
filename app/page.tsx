    ...
    <>
      ...
      <section className="relative overflow-hidden bg-[#D8CCBA] text-black">
        ...
        <div className="relative z-1 max-w-[1200px] mx-auto px-6 py-10 lg:py-10 text-center">
          ...
          {/* Top heading */}
          <h2 className="font-bold text-4xl text-center md:text-5xl lg:text-7xl leading-[1.15] max-w-[327px] md:max-w-[900px] lg:max-w-[1200px] mx-auto font-goudy-agency md:whitespace-normal"> Praxis For The New Renaissance </h2>

          <p className="text-2xl md:text-3xl lg:text-4xl leading-[1.15] text-center max-w-[1095px] font-goudy my-4  md:my-4"> Sometimes it's founders that can bring everything together, other times you need experts at resource building to help.
          ...
          {/* Second heading */}
          <h3 className="mt-[14px] font-bold text-4xl sm:text-5xl lg:text-7xl  font-goudy-agency leading-[1.15] text-black"> Ideas distilled to brilliance </h3>
          {/* Icon row */}
      ...
      <section className="relative flex flex-col justify-center items-center overflow-hidden bg-[#D8CCBA] text-black min-h-[435px] text-center px-6">
        ...
        <div className="relative z-1 max-w-[1200px] mx-auto flex flex-col items-center gap-8">
          {/* Main heading */}
          <h1 className="text-4xl md:text-5xl lgd:text-7xl max-w-[667px] mt-7 font-bold font-goudy-agency">
            The Residency
          </h1>

          {/* Quote */}
          <div className="max-w-[900px] mx-auto">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-goudy leading-snug">
              Everything should be made as simple as possible, but no simpler
            </h2>
            <p className="text-right text-xl mt-2 font-goudy">
              ~ Albert Einstein
            </p>
          </div>
          ...
          {/* Tagline */}
          <p className=" text-xl md:text-2xl  font-goudy text-center">
      ...
      <section className="relative overflow-hidden bg-[#D8CCBA] text-black px-6 py-[51px]">
        ...
        <div className="relative z-1 max-w-[1400px] mx-auto text-center">
          ...
          {/* paragraph */}
          <p className="mt-8 text-xl md:text-2xl text-shadow-2xs text-black text-center text-justify sm:text-center max-w-[1245px] font-goudy mx-auto">
      ...
      <section className="relative overflow-hidden bg-[#D8CCBA] text-black px-6 py-4">
        ...
        <div className="relative z-1 max-w-[1400px] mx-auto flex flex-col gap-12">
          <h1 className="text-center font-bold text-4xl  md:text-7xl font-goudy-agency">
            Our Residents
          </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mx-4 lg:mx-20">
            ...
            <div className="flex flex-col text-center lg:text-left max-w-[700px] order-2 lg:order-1">
              ...
              <p className="mt-6 text-2xl lg:text-4xl font-goudy text-black max-w-[680px]">
              ...
              <div className="mt-10">
                <a href="/inside">
                <TextureButton className="text-2xl lg:text-4xl px-8 py-3 font-goudy-old">
                  View all Residents
                </TextureButton>
                </a>
              </div>
