        ...
        <div>
            <section className="relative w-full min-h-[800px] flex flex-col items-center justify-center text-center overflow-hidden">
                ...
                <div className="relative z-10 max-w-[1000px] mx-auto px-4 pt-24 md:pt-32">
                    <h2 className="font-[OPTIGoudy_Agency] text-4xl md:text-5xl lg:text-7xl font-bold text-black drop-shadow-[0_1px_1px_rgba(0,0,0,0.2)]">
                        Meet Our Residents
                    </h2>

                    <p className="font-[GoudyOldStyle] text-2xl md:text-3xl lg:text-4xl font-bold max-w-[894px] text-black my-4">
